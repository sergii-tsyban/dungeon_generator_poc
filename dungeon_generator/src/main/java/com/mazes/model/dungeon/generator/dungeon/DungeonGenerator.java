...
public class DungeonGenerator {
    ...
    public static final int ATTEMPTS_PER_ROOM = 1000;
    ...
    public static DCorridor connect(DRoom from, DRoom to) {
        ...
        Random r = new Random();
        boolean xDirection = r.nextBoolean();
    ...
    public List<DRoom> createRooms(int x, int y, int w, int h) {
        return generateRandom(x, y, w, h);
    }

    public List<DCorridor> createCorridors(List<DRoom> rooms) {
    ...
    public List<DCorridor> buildCorridors(List<Edge<DRoom>> edges) {
        ...
        for (Edge<DRoom> edge : edges) {
            ...
            DCorridor corridor = connect(from, to);
            from.addCorridor(corridor);
            to.addCorridor(corridor);
